...
// - Persistência local via localStorage ("geduc-data")
  ...
  constructor() {
    ...
    this.dados = {
      colaboradores: [
        ...
        { id: 'lucena',        nome: 'Lucena',        vinculo: 'Agente',       turnoPadrao: ['manha','tarde'], licenca: null,      reducao: null },
        { id: 'c_cunha',       nome: 'C. Cunha',      vinculo: 'Agente',       turnoPadrao: ['manha','tarde'], licenca: null,      reducao: null },
        { id: 'kariny',        nome: 'Kariny',        vinculo: 'Agente',       turnoPadrao: ['manha','tarde'], licenca: 'médica',  reducao: null },
        { id: 'luana',         nome: 'Luana',         vinculo: 'Agente',       turnoPadrao: ['manha'],         licenca: null,      reducao: ['segunda','terça','quarta'] },
        { id: 'barreira',      nome: 'Barreira',      vinculo: 'Agente',       turnoPadrao: ['manha'],         licenca: null,      reducao: ['terça','quarta','quinta'] },

        // Agentes operacionais
        { id: 'luiz_mesquita', nome: 'Luiz Mesquita', vinculo: 'Agente',       turnoPadrao: ['manha'], licenca: null,     reducao: null },
        { id: 'facanha',       nome: 'Façanha',       vinculo: 'Agente',       turnoPadrao: ['manha'], licenca: 'prêmio', reducao: null },
        { id: 'robson',        nome: 'Robson',        vinculo: 'Agente',       turnoPadrao: ['manha'], licenca: null,     reducao: null },
        { id: 'wellington',    nome: 'Wellington',    vinculo: 'Agente',       turnoPadrao: ['manha'], licenca: null,     reducao: null },
        { id: 'kelber',        nome: 'Kelber',        vinculo: 'Agente',       turnoPadrao: ['manha'], licenca: 'prêmio', reducao: null },
        { id: 'rafael',        nome: 'Rafael',        vinculo: 'Agente',       turnoPadrao: ['manha'], licenca: null,     reducao: null },
        { id: 'heberfran',     nome: 'Heberfran',     vinculo: 'Agente',       turnoPadrao: ['manha'], licenca: null,     reducao: null },
        { id: 'helder',        nome: 'Helder',        vinculo: 'Agente',       turnoPadrao: ['manha'], licenca: null,     reducao: null },
        ...
        { id: 'ana_cleide',    nome: 'Ana Cleide',    vinculo: 'Terceirizado', turnoPadrao: ['manha','tarde'], licenca: null, reducao: null },

        // Orientadores Via Livre (manhã por padrão, exceto Carlos Eduardo à tarde)
        { id: 'alberto',       nome: 'Alberto',       vinculo: 'Terceirizado', turnoPadrao: ['manha'], licenca: null, reducao: null, orientadorViaLivre: true },
        { id: 'edson',         nome: 'Edson',         vinculo: 'Terceirizado', turnoPadrao: ['manha'], licenca: null, reducao: null, orientadorViaLivre: true },
        { id: 'romario',       nome: 'Romário',       vinculo: 'Terceirizado', turnoPadrao: ['manha'], licenca: null, reducao: null, orientadorViaLivre: true },
        { id: 'joao_rafael',   nome: 'João Rafael',   vinculo: 'Terceirizado', turnoPadrao: ['manha'], licenca: null, reducao: null, orientadorViaLivre: true },
        { id: 'joao_victor',   nome: 'João Victor',   vinculo: 'Terceirizado', turnoPadrao: ['manha'], licenca: null, reducao: null, orientadorViaLivre: true },
        { id: 'samoel',        nome: 'Samoel',        vinculo: 'Terceirizado', turnoPadrao: ['manha'], licenca: null, reducao: null, orientadorViaLivre: true },
        { id: 'clemilson',     nome: 'Clemilson',     vinculo: 'Terceirizado', turnoPadrao: ['manha'], licenca: null, reducao: null, orientadorViaLivre: true },
        ...
        { id: 'lidomar',       nome: 'Lidomar',       vinculo: 'Terceirizado', turnoPadrao: ['manha'], licenca: null, reducao: null, orientadorViaLivre: true }
      ],
